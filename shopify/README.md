# Shopify
## Description:
Web platform for delicious food online...
...
### Home/Register/Login area
  ...
  Initialy every user is treat as Guest before registratrion and log in.

### Administator area
- Producs (food) - CRUD
- Categories - CRUD
- Orders - Delete "when is all set"

### User area
-  Products - View | Add/Remove to Cart | Add/Remove to favourites.
-  Categories - View
-  Orders - Create
...
## Start
 You can view live demo on: https://sshopify.herokuapp.com/ or....
  ...
  ```
   ...
   $ git clone https://github.com/tanyogeorgiev/react-playground
   $ npm isntall
   $ npm start
